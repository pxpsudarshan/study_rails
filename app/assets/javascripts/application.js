...
$(document).ready(function() {
  ...
  setInterval(function() {
    ...
    var alert_btn = document.querySelector('.btn-close');
    if (alert && alert.classList.contains('show') && !alert.classList.contains('nation_alert')) {
      alert.classList.remove('show')
      // Trigger close button click if it exists
      if (alert_btn) alert_btn.click();
    }
  }, 1000);
...
//         link.classList.add("mx-1", "text-decoration-none", "btn", "rounded-0", "btn-outline-dark", "btn-sm"); 
