...
Rails.application.config.assets.precompile += %w( locales/en/common.messages.js )
...
Rails.application.config.assets.precompile += ['correct.mp3']
Rails.application.config.assets.precompile += ['admin/users.js','admin/channels.js', 'admin/block_ips.js']
...
Rails.application.config.assets.precompile += %w[admin/video_lessons.js admin/video_genres.js]
